...
const ContactForm = () => {
  return (
    ...
    >
      {/* Left Section */}
      <motion.div
        className="bg-white shadow-xl rounded-xl p-8 lg:w-1/3 border-l-4 border-indigo-500"
      ...
      >
        <div className="mb-8">
          <h3 className="text-2xl font-bold flex items-center gap-3 text-indigo-800">
            <FaPhoneAlt className="text-violet-400 text-3xl" />
      ...
      {/* Right Section */}
      <motion.div
        className="bg-white shadow-xl rounded-xl p-8 lg:w-2/3 border-l-4 border-blue-500"
        initial={{ opacity: 0, x: 50 }}
        animate={{ opacity: 1, x: 0 }}
        transition={{ duration: 0.8 }}
        whileHover={{ scale: 1.05, boxShadow: "0px 10px 20px rgba(0,0,0,0.2)" }}
        ...
        <form className="space-y-6">
          ...
          >
            <motion.input
              ...
              className="w-full border border-gray-300 rounded-lg p-3 focus:outline-none focus:ring-2 focus:ring-indigo-400 transition-all duration-300"
              required
          ...
          <motion.button
            type="submit"
            className="w-full md:w-auto bg-indigo-500 text-white px-8 py-3 rounded-lg font-semibold hover:bg-blue-500 transition-all duration-300"
